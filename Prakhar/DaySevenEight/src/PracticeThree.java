...
public class PracticeThree {
    //Design a Java class representing a bank account with private fields for balance and account number. Implement
    // methods to deposit and withdraw money while ensuring encapsulation.
...
class BankAccount {
    ...
    void withdraw(double withdrewMoney) {
        double net_bal=  this.balance - withdrewMoney;
        if(net_bal<0){
            System.out.println();
            System.out.println("You Don't have enough balance to withdrew that money");
        }else{
